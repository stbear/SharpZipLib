...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	internal static class ZipFormat
	{
		...
		public static void WriteZip64EndOfCentralDirectorySync(Stream stream, long noOfEntries, 
			long sizeEntries, long centralDirOffset)
		{
			stream.WriteProcToStreamSync(s => WriteZip64EndOfCentralDirectory(s, noOfEntries, sizeEntries, centralDirOffset));
		}
		...
		public static void WriteEndOfCentralDirectorySync(Stream stream, long noOfEntries, long sizeEntries, 
			long start, byte[] comment) 
			=> stream.WriteProcToStreamSync(s 
